...
> **Status: NEEDS SETUP** — Run `/setup` or say "set up this control room" to personalize.
...
- **Industry:** [INDUSTRY]
- **Location:** [LOCATION]
- **Account Owner:** [YOUR NAME] (Damco Digital)
...
| Name | Role | Side |
|---|---|---|
| [YOUR NAME] | [YOUR ROLE] | Agency |
| [Add more team members] | | Agency |
...
```
Subject: MOM — [Client Name] [Meeting Type] | [Date]
...
[Client Name] — [DD Month YYYY] | Due before [next meeting date]

Key discussions to know:
- [One tight sentence per topic — what changed and why it matters]

[Team member name]'s actions:
- [Specific action] | By [date]

[Repeat for each person with actions. Only include people who have actions.]
```
...
```
Client Signals
From [Client names] | [DD Month YYYY]
...
```
Linear Update — [Client Name] | [DD Month YYYY]
...
- MOM emails: professional, warm, concise. No internal jargon. Client-ready as-is.
...
- [ADD YOUR STYLE RULES HERE DURING SETUP]

---

## Function-Specific Modules

> During setup, the system will add the relevant module below based on your role.
> Available modules: SEO, Paid Ads, Social Media, Content, Account Management

<!-- MODULE PLACEHOLDER — replaced during setup -->
